...
if __name__ == '__main__':
    ...
    data_df = process_data('./bisaidata/labeled_data.csv', classes2idx, True)
    
    train_df, val_df = train_test_split(data_df, test_size=0.2, shuffle=True, random_state=1)
    
    print("Reading training data...")
    train_set = CustomDataset(train_df, maxlen=200, model_name=model_name)
    train_loader = Data.DataLoader(train_set, batch_size=batch_size, num_workers=5, shuffle=True)
    
    print("Reading validation data...")
    val_set = CustomDataset(val_df, maxlen=200, model_name=model_name)
    ...
    #test_df = process_data('./bisaidata/test_data.csv', classes2idx, False)
