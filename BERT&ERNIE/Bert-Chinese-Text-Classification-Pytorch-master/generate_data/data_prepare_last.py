...
lda_label_path = "people_labeled_data.txt"
...
def main():
    ...
    add_ty_train_data = random.sample(add_ty_train_data, 1500)
    add_yl_train_data = random.sample(add_yl_train_data, 1500)
    add_yx_train_data = random.sample(add_yx_train_data, 1500)
    unlabeled_data_list = random.sample(unlabeled_data_list, 7000)
